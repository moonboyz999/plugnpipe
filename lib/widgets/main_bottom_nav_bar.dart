    ...
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        items: [
          ...
          _navItem(Icons.notifications, 'Notifications', currentIndex == 2),
...
class TechNavBar extends StatelessWidget {
    ...
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        items: [
          ...
          _notificationNavItem(currentIndex == 2),
          _navItem(Icons.person, 'Profile', currentIndex == 3),
        ],
      ),
    );
  ...
  BottomNavigationBarItem _notificationNavItem(bool selected) {
    return BottomNavigationBarItem(
      icon: Container(
        decoration: selected
            ? BoxDecoration(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        items: [
          _navItem(Icons.home, 'Home', currentIndex == 0),
          _navItem(Icons.description, 'Reports', currentIndex == 1),
          _navItem(Icons.engineering, 'Technicians', currentIndex == 2),
          _navItem(Icons.person, 'Profile', currentIndex == 3),
        ],
      ),
    );
