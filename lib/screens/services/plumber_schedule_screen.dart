...
class PlumberScheduleScreen extends StatefulWidget {
  final String location;
  final String serviceType;
  final List<String> issues;

  const PlumberScheduleScreen({
    super.key,
  ...
  @override
  State<PlumberScheduleScreen> createState() => _PlumberScheduleScreenState();
}

class _PlumberScheduleScreenState extends State<PlumberScheduleScreen> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Please confirm your plumber request:'),
              const SizedBox(height: 12),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'Your plumber request has been submitted successfully and notifications have been sent to available technicians.\n\n'
